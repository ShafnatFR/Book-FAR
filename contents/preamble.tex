...
% --- Bibliography Setup ---
\usepackage[style=numeric, sorting=none, backend=biber, language=american]{biblatex}
\DeclareLanguageMapping{indonesian}{american}
\addbibresource{referensi.bib}

% Remove bold from bibliography (some styles use bold for volume/year)
% Localization for Indonesian labels in Bibliography
% Since biblatex-apa is used, we define missing APA specific macros
\providecommand{\datecircaprint}{}
\providecommand{\dateuncertainprint}{}
\providecommand{\mkbibdateapalongextra}{}
\providecommand{\mkbibdateapalong}{}
