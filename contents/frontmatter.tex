...
\begin{titlepage}
    ...
    {\Huge\bfseries\color{black} Food AI Rescue \par}
    \vspace{1cm}
    {\Large\bfseries Dokumen ini ditujukan untuk memenuhi persyaratan Mata Kuliah Tugas Akhir Jalur Reguler\par}
...
\begin{center}
    ...
    LEMBAR PERSEMBAHAN \\
    \vspace{2cm}
    Alhamdulillah, karya ini dipersembahkan untuk orang tua tercinta... \\
    \vspace{1cm}
    dan seluruh pihak yang telah membantu dalam penyusunan tugas akhir ini.
\end{center}
...
\begin{center}
    ...
    {\large\bfseries FOOD AI RESCUE: PLATFORM MARKETPLACE DAN BERBAGI RESEP UNTUK MENGURANGI FOOD WASTE \par}
    \vspace{0.3cm}
    {\large\itshape\bfseries FOOD AI RESCUE: MARKETPLACE AND RECIPE SHARING PLATFORM TO REDUCE FOOD WASTE \par}
\end{center}
